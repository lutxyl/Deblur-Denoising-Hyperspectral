...
|(HSI-SDeCNN)A Single Model CNN for Hyperspectral Image Denoising|.[trans2019].(https://ieeexplore.ieee.org/abstract/document/8913713)|
.[code]|(https://github.com/mhaut/HSI-SDeCNN)|A Single Model CNN for Hyperspectral Image Denoising|Xiujuan Lang|
## Link of datasets
